...
const ScheduleSidebar: React.FC<ScheduleSidebarProps> = ({
  ...
  return (
    <>
      <aside className={`fixed inset-y-0 right-0 z-40 w-72 bg-card-dark p-4 flex-shrink-0 border-l border-border-dark flex flex-col transform transition-transform md:relative md:translate-x-0 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
