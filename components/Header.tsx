...
const Header: React.FC<HeaderProps> = ({ onMenuClick, onSearchClick, currentItem }) => {
  ...
  return (
    <header className="flex items-center justify-between h-16 px-4 sm:px-8 bg-surface-dark/80 backdrop-blur-md border-b border-white/5 shadow-sm flex-shrink-0 relative z-30">
